...
// HELPER & SETUP
// =================================================================================
function printHeader(section, title) {
...
async function runDemo() {
    ...
    try {
        ...
        const testChains = ['POLYGON', 'ARBITRUM', 'BASE'];
        ...
        console.error('   - ❌ Failed to perform EVM read operations:', error.message);
    }
    ...
    try {
        ...
        console.error('   - ❌ Failed to perform Solana operations:', error.message);
    }
    ...
    */
    ...
    try {
        ...
        console.error('   - ❌ Failed to perform NFT/Data operations:', error.message);
    }
    ...
    try {
        ...
        console.error('   - ❌ Failed to get price from Chainlink:', error.message);
    }
